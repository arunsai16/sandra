function [sys,x0,str,ts] = intelligent_controller(t,x,u,flag)
...
%introducing the fault control
fault_limiter=0;
if t>10
    fault_limiter=1;
end
tau1=M11*s1+M12*s2+N1-fault_limiter*(M11*estimated_fault_func);
tau2=M12*s1+M22*s2+N2-fault_limiter*(M12*estimated_fault_func);
